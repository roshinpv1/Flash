...
// even though a fresh shell — and the Flash CLI — sees it immediately. The
// desktop's HERMES_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\flash. Reading
...
//       HERMES_HOME    REG_SZ    F:\Flash\data
//

 ...
 *
 * A public install can end up with `origin=git@github.com:FlashOrg/flash-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/FlashOrg/flash-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/flashorg/flash-agent'

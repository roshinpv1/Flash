...
test('resolveRemovableAppPath finds the install dir on Windows', () => {
  ...
  assert.equal(
    resolveRemovableAppPath('C:\\Users\\x\\AppData\\Local\\flash-desktop\\Hermes.exe', 'win32'),
...
test('resolveRemovableAppPath uses APPIMAGE on Linux when set', () => {
  assert.equal(
    resolveRemovableAppPath('/tmp/.mount_HermesXXXX/flash', 'linux', { APPIMAGE: '/home/x/Apps/Hermes.AppImage' }),

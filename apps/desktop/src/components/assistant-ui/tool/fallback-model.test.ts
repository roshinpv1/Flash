  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://flash-agent.flashorg.com/docs' },
    ...
    expect(view.title).toBe('Failed to open flash-agent.flashorg.com')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://flash-agent.flashorg.com/docs' },
        result: { success: true, url: 'https://flash-agent.flashorg.com/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened flash-agent.flashorg.com')
  })
})

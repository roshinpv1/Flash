...
export const en: Translations = {
  ...
  boot: {
    ready: 'Flash Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Flash settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingFlashDesktop: 'Starting Flash Desktop…'
    },
    errors: {
      backgroundExited: 'Flash background process exited.',
      backgroundExitedDuringStartup: 'Flash background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Flash backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Flash Desktop.',
    ...
    native: {
      ...
      inputBody: 'Flash is waiting for your response.',
      turnDoneTitle: 'Flash finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Flash defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Flash is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Flash asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Flash was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Flash follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Flash is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Flash, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Flash checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Flash configuration...',
    ...
    gateway: {
      ...
      intro:
        'Flash Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Flash backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Flash backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Flash backend.',
      remoteAuthHint:
        'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Flash Cloud',
      cloudDesc: 'Sign in once to Flash Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Flash Cloud',
      cloudSignIn: 'Sign in to Flash Cloud',
      cloudSignedIn: 'Signed in to Flash Cloud',
      cloudNeedsSignIn: 'Sign in to Flash Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Flash Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Flash Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Flash Cloud',
      cloudSignedOutMessage: 'Cleared the Flash Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /flash.',
      ...
      restartingMessage: 'Flash Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Flash ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Flash runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via flash curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Flash builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Flash to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Flash to generate pets.',
      backgroundHint: 'You can close this — Flash will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Flash desktop' },
    ...
    flashActiveSessions: (version, count) => `Flash ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@flash:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Flash environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Flash will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Flash backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Flash. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Flash...',
    placeholderReconnecting: 'Reconnecting to Flash…',
    ...
    attachUrlDesc: 'Flash will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Flash to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Flash…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Flash…',
    ...
    unsupportedMessage: 'This version of Flash can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Flash from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Flash will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Flash desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Flash updater takes over in its own window and reopens Flash automatically when it’s done. Please don’t reopen Flash yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Flash reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Flash reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Flash needs a one-time install',
    ...
    settingUpTitle: 'Setting up Flash Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Flash CLI or desktop instance is running. Stop any running Flash instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Flash Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Flash is finishing install. This usually takes under a minute on first run.',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Flash',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Flash at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Flash connects automatically',
    ...
    authorizeThere: 'Authorize Flash there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Flash there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Flash Desktop v${version}`,
      ...
      gatewayTitle: 'Flash inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Flash will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Flash is restarting...',
      askRestart: 'Ask Flash to restart the server',
      lookingRestart: taskId => `Flash is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Flash is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Flash finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Flash could not restart the server.',
      stillWorking:
        'Flash is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Flash is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Flash gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.flash/config.yaml). Flash won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Flash needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Flash needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Flash Desktop to use Save Image.',
    restartToSaveImages: 'Restart Flash Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `flash gateway` running?'
    }
  },

...
export const en: Translations = {
  ...
  boot: {
    ready: 'Nyxo Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Nyxo settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingNyxoDesktop: 'Starting Nyxo Desktop…'
    },
    errors: {
      backgroundExited: 'Nyxo background process exited.',
      backgroundExitedDuringStartup: 'Nyxo background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Nyxo backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Nyxo Desktop.',
    ...
    native: {
      ...
      inputBody: 'Nyxo is waiting for your response.',
      turnDoneTitle: 'Nyxo finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Nyxo defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Nyxo is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Nyxo asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Nyxo was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Nyxo follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Nyxo is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Nyxo, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Nyxo checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Nyxo configuration...',
    ...
    gateway: {
      ...
      intro:
        'Nyxo Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Nyxo backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset NYXO_DESKTOP_REMOTE_URL and NYXO_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Nyxo backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Nyxo backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /nyxo.',
      ...
      restartingMessage: 'Nyxo Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Nyxo ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Nyxo runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Nyxo to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Nyxo to generate pets.',
      backgroundHint: 'You can close this — Nyxo will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Nyxo desktop' },
    ...
    nyxoActiveSessions: (version, count) => `Nyxo ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@nyxo:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Nyxo environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Nyxo will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Nyxo...',
    placeholderReconnecting: 'Reconnecting to Nyxo…',
    ...
    attachUrlDesc: 'Nyxo will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Nyxo…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Nyxo…',
    ...
    unsupportedMessage: 'This version of Nyxo can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Nyxo from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Nyxo will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Nyxo desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Nyxo updater takes over in its own window and reopens Nyxo automatically when it’s done. Please don’t reopen Nyxo yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Nyxo reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Nyxo reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Nyxo needs a one-time install',
    ...
    settingUpTitle: 'Setting up Nyxo Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Nyxo CLI or desktop instance is running. Stop any running Nyxo instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Nyxo installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Nyxo Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Nyxo is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Nyxo…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Nyxo',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Nyxo at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Nyxo connects automatically',
      loopback: 'Opens your browser to sign in — Nyxo connects automatically',
    ...
    authorizeThere: 'Authorize Nyxo there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Nyxo there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Nyxo inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Nyxo will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Nyxo is restarting...',
      askRestart: 'Ask Nyxo to restart the server',
      lookingRestart: taskId => `Nyxo is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Nyxo is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Nyxo finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Nyxo could not restart the server.',
      stillWorking:
        'Nyxo is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Nyxo is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Nyxo gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.nyxo/config.yaml). Nyxo won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Nyxo needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Nyxo needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Nyxo Desktop to use Save Image.',
    restartToSaveImages: 'Restart Nyxo Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `nyxo gateway` running?'
    }
  },

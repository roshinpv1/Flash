...
export const en: Translations = {
  ...
  commandCenter: {
    ...
    flashActiveSessions: (version, count) => `Hermes ${version} · Active sessions ${count}`,
  ...
  assistant: {
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.flash/config.yaml). Hermes won’t ask again for commands like this — in this session or any future one.`,

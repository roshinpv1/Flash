...
// hairline `--stroke-flash` paired with the soft `--shadow-flash` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-flash) bg-(--ui-chat-bubble-background) shadow-flash [-webkit-app-region:no-drag]'

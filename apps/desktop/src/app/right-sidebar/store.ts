...
const TAKEOVER_KEY = 'nyxo.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Nyxo can't clear via the API — the user
 *  sees exactly what runs instead of Nyxo silently deleting their creds. */

...
const TAKEOVER_KEY = 'flash.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Flash can't clear via the API — the user
 *  sees exactly what runs instead of Flash silently deleting their creds. */

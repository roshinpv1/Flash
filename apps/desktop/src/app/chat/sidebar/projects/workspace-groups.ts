...
import type { ProjectInfo, SessionInfo } from '@/flash'
 ...
 * repo shows its branches/worktrees even when they have no Flash sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: FlashGitWorktree[]
): SidebarSessionGroup[] {

...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/flash'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('flash:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('flash:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Flash to

...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/nyxo'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('nyxo:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('nyxo:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])

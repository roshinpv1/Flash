...
import type { SessionInfo, SessionMessage } from '@/types/flash'
...
describe('collectArtifactsForSession', () => {
  ...
  it('resolves remote image artifact thumbnails through the desktop fs bridge', async () => {
    ...
    const path = '/Users/me/.flash/skills/work-esab/references/images/manual-step03.jpeg'
    ...
    expect(api).toHaveBeenCalledWith({
      path: '/api/fs/read-data-url?path=%2FUsers%2Fme%2F.flash%2Fskills%2Fwork-esab%2Freferences%2Fimages%2Fmanual-step03.jpeg'
    })
  })
})

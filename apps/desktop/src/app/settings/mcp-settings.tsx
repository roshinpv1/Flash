...
import { getNyxoConfigRecord, type NyxoGateway, saveNyxoConfig } from '@/nyxo'
...
function getServers(config: NyxoConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveNyxoConfig(nextConfig)

...
import type { FlashConfigRecord, ToolsetInfo } from '@/types/flash'
...
export function getNested(obj: FlashConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: FlashConfigRecord, path: string, value: unknown): FlashConfigRecord {
...
function personalityOptions(config: FlashConfigRecord): string[] {

 ...
 * log inline — the GUI equivalent of the install step `flash tools` runs
...
/**
 * Backend model catalog — the GUI counterpart of the model picker `flash
            ...
            {isActive && (
              <div className="grid gap-2 bg-muted/20 p-3">
                ...
                {provider.requires_flash_auth && (
                  <p className="text-[0.72rem] text-muted-foreground">{copy.flashIncluded}</p>
                )}

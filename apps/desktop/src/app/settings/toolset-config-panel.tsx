...
import type { ActionStatusResponse, ToolEnvVar, ToolProvider, ToolsetConfig } from '@/types/nyxo'
 ...
 * log inline — the GUI equivalent of the install step `nyxo tools` runs

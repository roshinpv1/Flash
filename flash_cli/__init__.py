"""
Flash CLI - Unified command-line interface for Flash Agent.

Provides subcommands for:
- flash chat          - Interactive chat (same as ./flash)
- flash gateway       - Run gateway in foreground
- flash gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `flash setup` on a fresh Pi.
    ...
    flash_cli/stdio.py::configure_windows_stdio() runs later from the entry

"""``flash portal`` — the human-readable entry point for Nous Portal.
...
DEFAULT_PORTAL_URL = "https://portal.flashorg.com"
SUBSCRIPTION_URL = "https://portal.flashorg.com/manage-subscription"
DOCS_URL = "https://flash-agent.flashorg.com/docs/user-guide/features/tool-gateway"
...
def _cmd_login(args) -> int:
    ...
    """
    from flash_cli.setup import _run_portal_one_shot

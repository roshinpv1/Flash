"""
Skills configuration for Flash Agent.
`flash skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.flash/config.yaml under:
...
from flash_cli.config import cfg_get, load_config, save_config
from flash_cli.colors import Colors, color
from flash_cli.platforms import PLATFORMS as _PLATFORMS

...
Used by ``flash profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``flash_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Flash Agent kanban board.
...
Rules:
  ...
  - Never write "Flash Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_flash_home())
        else:

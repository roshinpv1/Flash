...
Usage:
    flash pairing list              # Show all pending + approved users
    flash pairing approve <platform> <code>  # Approve a pairing code
    flash pairing revoke <platform> <user_id> # Revoke user access
    flash pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle flash pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: flash pairing {list|approve|revoke|clear-pending}")
        print("Run 'flash pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.flash/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'flash pairing list' to see pending codes.\n")

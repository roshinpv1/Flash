...
Used by ``flash kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``flash_cli/goals.py`` — same aux
...
_SYSTEM_PROMPT = """You are the Kanban triage specifier for the Flash Agent board.
...
def _profile_author() -> str:
    """Mirror of ``flash_cli.kanban._profile_author``. Kept local to

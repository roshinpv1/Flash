...
TIPS = [
    ...
    "Ctrl+Z suspends Flash to the background — run fg in your shell to resume.",
    ...
    "flash mcp serve runs Flash itself as an MCP server for other agents.",
    ...
    "flash backup creates a zip backup of your entire Flash home directory.",
    ...
    "flash gateway install sets up Flash as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call Flash tools programmatically — results stay out of context.",
    ...
    "When exiting, Flash prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "Flash runs on 21 messaging platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, IRC, Microsoft Teams, email, and more.",
    ...
    "BlueBubbles brings iMessage to Flash via a local macOS server.",
    ...
    "Flash loads project context from .flash.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "flash acp runs Flash as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make Flash your own.",
    ...
    "Before a gateway session reset, Flash auto-flushes important facts to memory in the background.",
    ...
    "Profiles scope Flash state via HERMES_HOME; host tool subprocesses keep your real HOME unless terminal.home_mode is profile.",
    ...
    "Skills from trusted repos (FlashOrg) get a 'trusted' security level; community skills get extra scanning.",
    ...
    '/goal <text> sets a standing Ralph-loop objective — Flash auto-continues turn after turn until a judge says done.',
    '/snapshot create [label] saves a full state snapshot of Flash config; /snapshot restore <id> reverts later.',
    ...
    '/busy queue|steer|interrupt controls what pressing Enter does while Flash is working.',
    ...
    'flash dashboard embeds the full Flash TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'HERMES_ENABLE_PROJECT_PLUGINS=1 auto-loads repo-local plugins from ./.flash/plugins/ — trust-gated by design.',
    ...
    # --- Security ---
    'security.tirith_fail_open: false makes Flash block commands when the tirith scanner itself errors out.',

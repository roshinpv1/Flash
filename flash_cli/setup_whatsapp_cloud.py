...
Entry point: ``flash whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``flash_cli/main.py``).
...
Flash gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Flash to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Flash needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Flash gateway in another terminal:")
    print("         flash gateway")
    print()
    ...
    print()
    print("  Docs: https://flash-agent.flashorg.com/docs/user-guide/")

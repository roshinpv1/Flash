...
Invoked by ``flash kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Flash Agent board.
...
def _profile_author() -> str:
    """Mirror of ``flash_cli.kanban._profile_author``."""
    return (

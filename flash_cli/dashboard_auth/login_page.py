...
``tests/flash_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<title>Sign in — Flash Agent</title>
<style>
...
<body>
<main>
  <div class="brand">Flash<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Flash Agent dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Flash Agent</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;

...
Usage:
    nyxo pairing list              # Show all pending + approved users
    nyxo pairing approve <platform> <code>  # Approve a pairing code
    nyxo pairing revoke <platform> <user_id> # Revoke user access
    nyxo pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle nyxo pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: nyxo pairing {list|approve|revoke|clear-pending}")
        print("Run 'nyxo pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.nyxo/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'nyxo pairing list' to see pending codes.\n")

...
def _print_curator_first_run_notice() -> None:
    ...
    print(
        "  Docs:         https://nyxo-agent.flash.com/docs/user-guide/features/curator"
    )
...
def _update_via_zip(args):
    ...
    if branch != "main":
        ...
        sys.exit(1)
    zip_url = (
        f"https://github.com/Flash/nyxo-agent/archive/refs/heads/{branch}.zip"
    )
...
OFFICIAL_REPO_URLS = {
    "https://github.com/Flash/nyxo-agent.git",
    "git@github.com:Flash/nyxo-agent.git",
    "https://github.com/Flash/nyxo-agent",
    "git@github.com:Flash/nyxo-agent",
}
OFFICIAL_REPO_URL = "https://github.com/Flash/nyxo-agent.git"
...
def _sync_with_upstream_if_needed(git_cmd: list[str], cwd: Path) -> None:
    ...
    if not has_upstream:
        ...
        print("  This means you may miss updates from Flash/nyxo-agent.")
        print()
        try:
            response = (
        ...
        if response in {"", "y", "yes"}:
            ...
            if _add_upstream_remote(git_cmd, cwd):
                print(
                    "  ✓ Added upstream: https://github.com/Flash/nyxo-agent.git"
                )
                has_upstream = True
            else:
            ...
            print(
                "  Skipped. Run 'git remote add upstream https://github.com/Flash/nyxo-agent.git' to add later."
            )
...
def _maybe_setup_dashboard_auth_interactively(args) -> None:
    ...
    if choice == "2":
        ...
        print(
            ...
            "  Docs: https://nyxo-agent.flash.com/docs/"
...
def main():
    ...
    fallback_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://nyxo-agent.flash.com/docs/user-guide/features/fallback-providers"
        ),
    )
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "https://nyxo-agent.flash.com/docs/user-guide/secrets/bitwarden"
        ),
    )

"""
Nyxo CLI - Unified command-line interface for Nyxo Agent.

Provides subcommands for:
- nyxo chat          - Interactive chat (same as ./nyxo)
- nyxo gateway       - Run gateway in foreground
- nyxo gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `nyxo setup` on a fresh Pi.
    ...
    nyxo_cli/stdio.py::configure_windows_stdio() runs later from the entry

...
from nyxo_cli.proxy.adapters.base import UpstreamAdapter
from nyxo_cli.proxy.adapters.flash_portal import FlashPortalAdapter
...
# the ``nyxo proxy start --provider <name>`` CLI flag.

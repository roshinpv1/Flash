"""
Skills configuration for Nyxo Agent.
`nyxo skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.nyxo/config.yaml under:
...
from nyxo_cli.config import cfg_get, load_config, save_config
from nyxo_cli.colors import Colors, color
from nyxo_cli.platforms import PLATFORMS as _PLATFORMS

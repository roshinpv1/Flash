...
TIPS = [
    ...
    "hermes mcp serve runs Nyxo itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Nyxo home directory.",
    ...
    "hermes gateway install sets up Nyxo as a system service (systemd/launchd).",
    ...
    "Nyxo loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs Nyxo as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'hermes dashboard embeds the full Nyxo TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'NYXO_ENABLE_PROJECT_PLUGINS=1 auto-loads repo-local plugins from ./.hermes/plugins/ — trust-gated by design.',

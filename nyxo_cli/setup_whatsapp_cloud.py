...
Entry point: ``nyxo whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``nyxo_cli/main.py``).
...
Nyxo gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Nyxo to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Nyxo needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Nyxo gateway in another terminal:")
    print("         nyxo gateway")
    print()
    ...
    print()
    print("  Docs: https://nyxo-agent.nousresearch.com/docs/user-guide/")

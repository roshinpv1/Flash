...
This document is a contributor-facing index for existing Flash WebUI contracts,
...
- [`docs/rfcs/flash-run-adapter-contract.md`](rfcs/flash-run-adapter-contract.md):
...
- [`docs/architecture/agent-api-contract.md`](architecture/agent-api-contract.md):
  current audit of WebUI dependencies on the flash-agent source checkout and

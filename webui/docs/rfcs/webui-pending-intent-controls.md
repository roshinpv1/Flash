...
- **Created:** 2026-05-28
- **Tracking issue:** [#3058](https://github.com/nesquena/flash-webui/issues/3058)
- **Parent RFC:** [`live-to-final-assistant-replies.md`](live-to-final-assistant-replies.md) / [#3400](https://github.com/nesquena/flash-webui/issues/3400)
- **Related issues/PRs:** [#2555](https://github.com/nesquena/flash-webui/issues/2555), [#3108](https://github.com/nesquena/flash-webui/issues/3108), [#3808](https://github.com/nesquena/flash-webui/issues/3808), [#3822](https://github.com/nesquena/flash-webui/pull/3822), [NousResearch/flash-agent#28172](https://github.com/NousResearch/flash-agent/issues/28172)
- **Related docs:** [`webui-run-state-consistency-contract.md`](webui-run-state-consistency-contract.md), [`flash-run-adapter-contract.md`](flash-run-adapter-contract.md), [`turn-journal.md`](turn-journal.md)

## RFC Positioning

This RFC is a child RFC under the Flash WebUI Live-to-Final product line.
...
Flash WebUI currently treats user input during a running agent turn as one of
...
This boundary is necessary because Flash WebUI also has the #1925
...
directly. Flash Desktop / TUI Gateway already exposes related surfaces such as
...
- a private interrupt model independent of Flash Agent / TUI Gateway
...
- [#3400](https://github.com/nesquena/flash-webui/issues/3400): Live-to-Final
...
- [#3058](https://github.com/nesquena/flash-webui/issues/3058): Pending intent
  controls umbrella.
- [#3061](https://github.com/nesquena/flash-webui/pull/3061): RFC PR for this
  contract.
- [#3108](https://github.com/nesquena/flash-webui/issues/3108): Queue/draft
  durability.
- [#2555](https://github.com/nesquena/flash-webui/issues/2555): Steer runtime
  behavior, tool-call boundary, traceability, applied signal.
- [#3808](https://github.com/nesquena/flash-webui/issues/3808): legacy
  interrupt-and-send ownership bug.
- [#3822](https://github.com/nesquena/flash-webui/pull/3822): focused safety
  fix for #3808. It does not preserve Interrupt as default busy mode and does
  not complete pending intent controls.
- [#1925](https://github.com/nesquena/flash-webui/issues/1925):
  RuntimeAdapter / runtime ownership boundary.
- Flash Agent / TUI Gateway follow-up: required for reliable applied/consumed
  Steer evidence.
...
- What exact Flash Agent event shape, ordering, and metadata should prove

...
active profile home.  The modules live in flash-agent and may not be importable
...
def test_set_flash_home_patches_both_skill_tool_module_caches(monkeypatch, tmp_path):
    from api.profiles import _set_flash_home

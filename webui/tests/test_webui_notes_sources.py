...
def test_joplin_search_notes_returns_safe_snippets(monkeypatch):
    ...
    def fake_get(path, params=None):
        ...
        return {"items": [{
            "id": "abc123def4567890",
            "title": "Flash Context",
            "body": "This is a long Flash context note with useful details.",
            "parent_id": "folder123",
            "updated_time": 123,
        }]}
    ...
    results = routes._joplin_search_notes("Flash")

    assert results == [{
        "id": "abc123def4567890",
        "title": "Flash Context",
        "snippet": "This is a long Flash context note with useful details.",
        "parent_id": "folder123",
        "updated_time": 123,
        "source": "joplin",
    }]

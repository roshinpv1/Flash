...
def test_deleted_sessions_prune_all_session_tracking_maps():
    assert "const SESSION_VIEWED_COUNTS_KEY = 'flash-session-viewed-counts';" in SESSIONS_SRC
    assert "const SESSION_COMPLETION_UNREAD_KEY = 'flash-session-completion-unread';" in SESSIONS_SRC
    assert "const SESSION_OBSERVED_STREAMING_KEY = 'flash-session-observed-streaming';" in SESSIONS_SRC

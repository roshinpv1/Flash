...
def test_onboarding_uses_i18n_helpers():
    ...
    assert "onboarding_title: 'Welcome to Flash Web UI'" in i18n
    assert "onboarding_title: 'Bienvenido a Flash Web UI'" in i18n
...
def test_bootstrap_script_contains_official_installer_and_windows_guard():
    ...
    assert (
        "https://raw.githubusercontent.com/NousResearch/flash-agent/main/scripts/install.sh"
        in src
    )

...
const api = sandbox.window.FlashAssistantTurnAnchors;
...
def test_phase0_scaffold_is_loaded_before_current_rendering_modules():
    ...
    assert "FlashAssistantTurnAnchors" in ui_src
    assert "FlashAssistantTurnAnchors" not in _read(SESSIONS_JS)
...
def test_phase0_inventory_doc_matches_scaffold_contract():
    ...
    for marker in [
        ...
        "`FlashAssistantTurnAnchors.reconcileAssistantTurnAnchorActivityScene()`",

...
context.window.__flashSetBackgrounded(params.desktopBackgrounded);
vm.runInContext(
...
console.log(JSON.stringify({
  ...
  setterType: typeof context.window.__flashSetBackgrounded,
}));
"""
    )
...
context.window.__flashSetBackgrounded(true);
context.window.__flashSetBackgrounded(false);

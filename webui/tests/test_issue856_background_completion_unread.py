...
def test_background_completion_unread_uses_explicit_marker_not_message_delta():
    ...
    assert "SESSION_COMPLETION_UNREAD_KEY = 'flash-session-completion-unread'" in SESSIONS_JS
...
def test_polling_transition_marks_completion_when_long_running_stream_snapshot_advances():
    ...
    assert "SESSION_OBSERVED_STREAMING_KEY = 'flash-session-observed-streaming'" in SESSIONS_JS

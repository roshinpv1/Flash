...
def test_save_settings_syncs_default_model_provider_with_saved_model():
    ...
    assert "const modelChanged=(model||'')!==(_settingsFlashDefaultModelOnOpen||'')||((modelState.model_provider||null)!==(_settingsFlashDefaultModelProviderOnOpen||null));" in save_block
    ...
    assert "_settingsFlashDefaultModelProviderOnOpen=(models&&models.active_provider)||null;" in panels_js
    assert "if(Object.prototype.hasOwnProperty.call(body,'default_model_provider')) _settingsFlashDefaultModelProviderOnOpen=body.default_model_provider||null;" in apply_saved_block
    assert "(modelState.model_provider||null)!==(_settingsFlashDefaultModelProviderOnOpen||null)" in autosave_block

...
class TestCookieNameResolution(unittest.TestCase):
    ...
    def test_env_var_overrides_default(self):
        ...
        os.environ["HERMES_WEBUI_COOKIE_NAME"] = "flash_session_alt"
        self.assertEqual(auth._resolve_cookie_name(), "flash_session_alt")
    ...
    def test_set_cookie_uses_resolved_name(self):
        ...
        self.assertIn("flash_session_alt=", sent["Set-Cookie"])

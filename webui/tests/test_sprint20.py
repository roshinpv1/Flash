...
def test_boot_js_recognition_not_continuous():
    ...
    As of #5176 the value is sourced from the `flash-voice-continuous` localStorage
    ...
    assert (
        ...
        or "recognition.continuous=localStorage.getItem('flash-voice-continuous')==='true'" in js
    )

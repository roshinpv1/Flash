...
def test_list_profiles_api_contains_formatted_skills(monkeypatch, tmp_path):
    ...
    patches ``_get_default_flash_home`` / ``_get_profiles_root`` to point at a
    ...
    import flash_cli.profiles as cli_p
    monkeypatch.setattr(cli_p, "_get_default_flash_home", lambda: p_default)

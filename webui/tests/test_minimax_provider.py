...
def test_minimax_fallback_provider_label():
    ...
    for flash-agent routing to api.minimax.io. OpenRouter free-tier variants
...
def test_minimax_cn_provider_models_match_flash_agent_catalog():
...
def test_minimax_api_key_in_env_scan_tuple():
    ...
    MiniMax provider in the dropdown without editing ~/.flash/.env."""
...
def test_minimax_cn_key_can_be_managed_from_provider_settings():
    """Provider settings should use the Flash Agent env var for minimax-cn."""

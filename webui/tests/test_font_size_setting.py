...
class TestFontSizeBootScript:
    ...
    def test_boot_script_reads_flash_font_size(self):
        html = _read("static/index.html")
        assert "flash-font-size" in html, (
            "index.html boot script must read 'flash-font-size' from localStorage"
        )
...
class TestFontSizeJsFunctions:
    ...
    def test_pick_font_size_persists_to_localstorage(self):
        ...
        assert "localStorage.setItem('flash-font-size'" in block, (

...
def test_session_list_external_refresh_uses_sse_invalidation_not_polling():
    ...
    assert "document._flashSessionEventsVisibilityHook" in SESSIONS_JS
    ...
    assert ensure_fn.find("document._flashSessionEventsVisibilityHook") < ensure_fn.find("_sidebarSseBackgrounded()) return")

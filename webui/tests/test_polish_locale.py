...
def test_polish_locale_includes_representative_translations():
    ...
    expected = [
        ...
        "onboarding_title: 'Witaj w Flash Web UI'",
    ]
...
def test_polish_settings_detail_descriptions_are_translated():
    ...
    expected = [
        ...
        "settings_desc_sync_insights: 'Odzwierciedla zużycie tokenów WebUI w state.db, dzięki czemu flash /insights uwzględnia dane sesji przeglądarki. Domyślnie wyłączone.'",

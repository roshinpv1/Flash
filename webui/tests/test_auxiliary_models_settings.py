...
class TestAuxiliaryModelsBackend:
    ...
    def test_default_model_routes_drop_auxiliary_auto_provider_sentinel(self, monkeypatch):
        ...
        monkeypatch.setattr(routes, "set_flash_default_model", fake_set_default_model)
    ...
    def test_backend_aux_task_slots_include_agent_defaults(self):
        """Backend allow-list must include newer Flash auxiliary slots."""
    ...
    def test_set_flash_default_model_persists_advanced_options(self, monkeypatch, tmp_path):
        ...
        result = config.set_flash_default_model(
            "gpt-5.5",
            advanced={
                "base_url": "https://example.invalid/v1/",
                "timeout": "45",
    ...
    def test_set_flash_default_model_persists_explicit_provider_override(self, monkeypatch, tmp_path):
        from api import config
        ...
        result = config.set_flash_default_model("gpt-5.5", provider="anthropic")
    ...
    def test_set_flash_default_model_provider_override_replaces_stale_custom_base_url(self, monkeypatch, tmp_path):
        from api import config
        ...
        result = config.set_flash_default_model("gpt-5.5", provider="openai")
    ...
    def test_set_flash_default_model_clear_api_key_removes_key(self, monkeypatch, tmp_path):

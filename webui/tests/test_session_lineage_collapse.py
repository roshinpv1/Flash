...
const sessions = [
  {{session_id:'root', title:'Flash WebUI', message_count:10, updated_at:10, last_message_at:10, _lineage_root_id:'root', _lineage_tip_id:'root'}},
  {{session_id:'tip', title:'Flash WebUI', message_count:20, updated_at:20, last_message_at:20, _lineage_root_id:'root', _lineage_tip_id:'tip'}},
...
const sessions = [
  {{session_id:'root', title:'Flash WebUI', message_count:10, updated_at:10, last_message_at:10, _lineage_root_id:'root', _lineage_tip_id:'tip'}},
  {{session_id:'tip', title:'Flash WebUI', message_count:20, updated_at:20, last_message_at:20, _lineage_root_id:'root', _lineage_tip_id:'tip'}},
];
const collapsed = _collapseSessionLineageForSidebar(sessions);
...
const refreshA = [
  {{session_id:'root', title:'Optimizing Flash Development', updated_at:40, last_message_at:40, _lineage_root_id:'root', _lineage_tip_id:'tip', _compression_segment_count:2}},
  {{session_id:'tip', title:'Optimizing Flash Development', parent_session_id:'root', updated_at:20, last_message_at:20, _lineage_root_id:'root', _lineage_tip_id:'tip', _compression_segment_count:2}},
  {{session_id:'fork-child', title:'Optimizing Flash Development child', parent_session_id:'root', relationship_type:'child_session', session_source:'fork', _parent_lineage_root_id:'root', _parent_lineage_tip_id:'tip', updated_at:50, last_message_at:50}},
];
const refreshB = [
  {{session_id:'root', title:'Optimizing Flash Development', updated_at:10, last_message_at:10, _lineage_root_id:'root', _lineage_tip_id:'tip', _compression_segment_count:2}},
  {{session_id:'tip', title:'Optimizing Flash Development', parent_session_id:'root', updated_at:60, last_message_at:60, _lineage_root_id:'root', _lineage_tip_id:'tip', _compression_segment_count:2}},
  {{session_id:'fork-child', title:'Optimizing Flash Development child', parent_session_id:'root', relationship_type:'child_session', session_source:'fork', _parent_lineage_root_id:'root', _parent_lineage_tip_id:'tip', updated_at:50, last_message_at:50}},
];
...
const parentRow={{
  ...
  _lineage_segments:[
    {{session_id:'tip', title:'Flash WebUI #8', display_title:'Flash WebUI #177'}},
    {{session_id:'old-parent', title:'Flash WebUI #8', display_title:'Flash WebUI #176'}},
  ],
}};
const child={{
  session_id:'child',
...
"""
    ...
    assert child["_parent_segment_title"] == "Flash WebUI #176"


def test_default_webui_numbered_titles_are_not_treated_as_hash_tags():
    """The reconciled title 'Flash WebUI #177' must render with its number intact."""
    js = SESSIONS_JS_PATH.read_text(encoding="utf-8")
    source = f"""
const src = {js!r};
function extractFunc(name) {{
...
console.log(JSON.stringify({{
  webui:_sessionTitleTags('Flash WebUI #177'),

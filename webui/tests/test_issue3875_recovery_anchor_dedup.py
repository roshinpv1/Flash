...
def test_tool_first_recovery_creates_single_empty_anchor(flash_home):
...
def test_repeated_recovery_does_not_accumulate_empty_anchors(flash_home):
...
def test_distinct_streams_get_distinct_anchors(flash_home):
...
def test_text_bearing_recovery_still_appends_real_content(flash_home):

...
def test_local_test_runner_uses_supported_venv_before_pytest_collection():
    ...
    assert "Flash WebUI tests require Python 3.11, 3.12, or 3.13" in conftest
...
def test_live_model_success_log_is_debug_not_default_console_log():
    ...
    assert "console.debug('[flash] Live models loaded" in ui
    assert "console.log('[flash] Live models loaded" not in ui

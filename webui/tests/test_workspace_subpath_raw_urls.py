...
`/flash/`. But several callers use the route DIRECTLY, bypassing `api()`:
...
class TestWorkspaceSubpathRawUrls:
    ...
    def test_raw_url_keeps_subpath_prefix(self):
        ...
        js = (
            ...
            + ";\n"
            + r"""
global.document = { baseURI: 'https://host.example/pod-123/flash/' };
...
"""
        ...
        prefix = "https://host.example/pod-123/flash/api/"
        ...
        assert result["raw"].count("/flash/") == 1, result["raw"]

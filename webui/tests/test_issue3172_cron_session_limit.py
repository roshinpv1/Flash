...
def test_cron_sessions_survive_when_outnumbered_by_recent_sessions(fake_flash_home, monkeypatch):
    ...
    db_path = fake_flash_home / "state.db"
...
def test_cron_sessions_deduplicated_across_passes(fake_flash_home, monkeypatch):
...
def test_cron_session_with_no_messages_excluded_from_second_pass(fake_flash_home, monkeypatch):

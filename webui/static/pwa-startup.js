...
(function () {
  ...
  syncMode();
  window.addEventListener('online', function () { syncMode(); dispatch('flash:pwa-connection-change', { online: true }); });
  window.addEventListener('offline', function () { syncMode(); dispatch('flash:pwa-connection-change', { online: false }); });
  ...
  window.addEventListener('beforeinstallprompt', function (event) {
    ...
    window.flashDeferredInstallPrompt = event;
    root.classList.add('pwa-installable');
    dispatch('flash:pwa-installable');
  });
  window.addEventListener('appinstalled', function () {
    window.flashDeferredInstallPrompt = null;
    root.classList.remove('pwa-installable');
    root.classList.add('pwa-installed');
    dispatch('flash:pwa-installed');
  });
  ...
  window.FlashPWA = {
    ...
    promptInstall: function () {
      var prompt = window.flashDeferredInstallPrompt;

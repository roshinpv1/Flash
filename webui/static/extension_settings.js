(function () {
  ...
  const SETTINGS_PREFIX = 'flash.ext.settings.';
  const STORAGE_PREFIX = 'flash.ext.storage.';
  ...
  window.FlashExtensionSettings = api;
  window.flashExt = window.flashExt || {};
  window.flashExt.settings = window.flashExt.settings || {};
  window.flashExt.storage = window.flashExt.storage || {};
  window.flashExt.settings.forExtension = settingsForExtension;
  window.flashExt.storage.forExtension = storageForExtension;

...
Flash Web UI splits **appearance** into two independent pickers:
...
| Skin | Description |
|------|-------------|
| **Default** | The original Flash gold accent. Warm and understated. |
...
2. **Self-hosted (no fork):** use the WebUI extensions surface — see
   ...
   Extensions that register a skin through `window.registerFlashSkin()` may

...
- **Sprint 25** — macOS desktop application. Native Swift + WKWebView shell, universal Intel + Apple Silicon DMG, Sparkle 2 auto-update. Lives in the separate `flash-webui/flash-swift-mac` repo.
...
- **Plugin marketplace** — Flash skills already cover this surface.

"""
Plugin discovery and static serving for Flash Web UI.

Scans ~/.flash/plugins/<name>/dashboard/ for manifest.json files,
matching the official Flash dashboard plugin format.
...
def _get_plugin_base() -> Path:
    return Path(os.environ.get("HERMES_WEBUI_PLUGINS_DIR", str(Path.home() / ".flash" / "plugins")))

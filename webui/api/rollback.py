"""
Flash Web UI -- Filesystem checkpoint (rollback) API.

Provides endpoints to list, diff, and restore filesystem checkpoints
created by the Flash agent's CheckpointManager.  Checkpoints live at
``{flash_home}/checkpoints/<hash>/`` as shadow git repositories.
"""
...
def _checkpoint_root() -> Path:
    return _flash_home() / "checkpoints"

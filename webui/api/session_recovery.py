...
def _main() -> int:
    parser = argparse.ArgumentParser(description="Audit Flash WebUI session recovery state")
    ...
    parser.add_argument("--state-db", type=Path, default=None, help="optional Flash state.db path")

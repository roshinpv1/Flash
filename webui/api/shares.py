"""
Flash Web UI -- public read-only share snapshots.
...
def _redact_share_paths(text: str, extra_paths) -> str:
    ...
    A workspace path or Flash home can be embedded inside message prose (an
...
def build_share_snapshot(session) -> dict:
    ...
    try:
        ...
        redact_paths.append(str(get_active_flash_home()))
    except Exception:
        pass
    try:

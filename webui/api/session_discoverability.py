"""Read-only sidebar discoverability audit for Flash WebUI sessions.
...
def _main() -> int:
    parser = argparse.ArgumentParser(description="Read-only Flash WebUI session discoverability audit")

"""Self-contained HTML export for a flash-webui session transcript.
...
def render_session_html(session: dict, theme: str = "dark", palette: dict | None = None) -> str:
    ...
    title = (session.get("title") or "Flash Conversation").strip()
...
<footer class="doc-foot">Exported from Flash WebUI on {exported}</footer>
</div>
</body>
</html>"""

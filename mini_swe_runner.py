#!/usr/bin/env python3
"""
SWE Runner with Nyxo Trajectory Format

A runner that uses Nyxo-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Nyxo-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Nyxo-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Nyxo format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Nyxo-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Nyxo-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Nyxo Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Nyxo-Agent's built-in execution environments
    and outputs trajectories in Nyxo-Agent format.
    """
    ...
    def _convert_to_nyxo_format(
        ...
        """
        Convert internal message format to Nyxo trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Nyxo trajectory format
        trajectory = self._convert_to_nyxo_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Nyxo trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Nyxo Trajectory Format")
    print("=" * 60)

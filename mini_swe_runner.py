#!/usr/bin/env python3
"""
SWE Runner with Flash Trajectory Format

A runner that uses Flash-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Flash-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Flash-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Flash format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Flash-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Flash-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Flash Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Flash-Agent's built-in execution environments
    and outputs trajectories in Flash-Agent format.
    """
    ...
    def _convert_to_flash_format(
        ...
        """
        Convert internal message format to Flash trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Flash trajectory format
        trajectory = self._convert_to_flash_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Flash trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Flash Trajectory Format")
    print("=" * 60)

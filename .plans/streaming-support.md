# Streaming LLM Response Support for Nyxo Agent
...
```
NYXO_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("NYXO_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `nyxo_cli/config.py` | 1 | +streaming config defaults |

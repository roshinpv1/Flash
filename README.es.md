...
# Hermes Agent ☤
<p align="center">
  <a href="https://hermes-agent.flashorg.com/">Hermes Agent</a> | <a href="https://hermes-agent.flashorg.com/">Hermes Desktop</a>
</p>
<p align="center">
  <a href="https://hermes-agent.flashorg.com/docs/"><img src="https://img.shields.io/badge/Docs-hermes--agent.flashorg.com-FFD700?style=for-the-badge" alt="Documentación"></a>
  ...
  <a href="https://github.com/FlashOrg/hermes-agent/blob/main/LICENSE"><img src="https://img.shields.io/badge/Licencia-MIT-green?style=for-the-badge" alt="Licencia: MIT"></a>
...
> **Nota:** En Windows nativo, Hermes funciona sin WSL — la CLI, el gateway, la TUI y las herramientas funcionan de forma nativa. Si prefieres usar WSL2, el comando de Linux/macOS de arriba también funciona allí. ¿Encontraste un error? Por favor [crea un issue](https://github.com/FlashOrg/hermes-agent/issues).

Ejecuta esto en PowerShell:

```powershell
iex (irm https://hermes-agent.flashorg.com/install.ps1)
```
...
> **Android / Termux:** La ruta manual probada está documentada en la [guía de Termux](https://hermes-agent.flashorg.com/docs/getting-started/termux). En Termux, Hermes instala el extra `.[termux]` curado porque el extra completo `.[all]` actualmente incluye dependencias de voz incompatibles con Android.
>
...
📖 **[Documentación completa →](https://hermes-agent.flashorg.com/docs/)**

---

## Evita la colección de claves API — Nous Portal

Hermes funciona con cualquier proveedor que quieras — eso no cambiará. Pero si prefieres no recopilar cinco claves API separadas para el modelo, búsqueda web, generación de imágenes, TTS y un navegador en la nube, **[Nous Portal](https://portal.flashorg.com)** las cubre todas bajo una sola suscripción:
...
Esto te autentica vía OAuth, establece Nous como tu proveedor y activa el Tool Gateway. Comprueba qué está conectado en cualquier momento con `hermes portal info`. Detalles completos en la [página de documentación del Tool Gateway](https://hermes-agent.flashorg.com/docs/user-guide/features/tool-gateway).
...
Para las listas de comandos completas, consulta la [guía de CLI](https://hermes-agent.flashorg.com/docs/user-guide/cli) y la [guía del Gateway de Mensajería](https://hermes-agent.flashorg.com/docs/user-guide/messaging).

---

## Documentación

Toda la documentación está en **[hermes-agent.flashorg.com/docs](https://hermes-agent.flashorg.com/docs/)**:

| Sección                                                                                             | Contenido                                                    |
| --------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| [Inicio rápido](https://hermes-agent.flashorg.com/docs/getting-started/quickstart)              | Instalar → configurar → primera conversación en 2 minutos   |
| [Uso de CLI](https://hermes-agent.flashorg.com/docs/user-guide/cli)                             | Comandos, atajos de teclado, personalidades, sesiones        |
| [Configuración](https://hermes-agent.flashorg.com/docs/user-guide/configuration)               | Archivo de configuración, proveedores, modelos, todas las opciones |
| [Gateway de Mensajería](https://hermes-agent.flashorg.com/docs/user-guide/messaging)           | Telegram, Discord, Slack, WhatsApp, Signal, Home Assistant   |
| [Seguridad](https://hermes-agent.flashorg.com/docs/user-guide/security)                        | Aprobación de comandos, emparejamiento por DM, aislamiento en contenedor |
| [Herramientas y Toolsets](https://hermes-agent.flashorg.com/docs/user-guide/features/tools)   | Más de 40 herramientas, sistema de toolsets, backends de terminal |
| [Sistema de Habilidades](https://hermes-agent.flashorg.com/docs/user-guide/features/skills)   | Memoria procedimental, Skills Hub, creación de habilidades   |
| [Memoria](https://hermes-agent.flashorg.com/docs/user-guide/features/memory)                   | Memoria persistente, perfiles de usuario, mejores prácticas  |
| [Integración MCP](https://hermes-agent.flashorg.com/docs/user-guide/features/mcp)              | Conecta cualquier servidor MCP para capacidades extendidas   |
| [Programación Cron](https://hermes-agent.flashorg.com/docs/user-guide/features/cron)           | Tareas programadas con entrega a plataforma                  |
| [Archivos de Contexto](https://hermes-agent.flashorg.com/docs/user-guide/features/context-files) | Contexto de proyecto que da forma a cada conversación      |
| [Arquitectura](https://hermes-agent.flashorg.com/docs/developer-guide/architecture)            | Estructura del proyecto, bucle del agente, clases principales |
| [Contribuir](https://hermes-agent.flashorg.com/docs/developer-guide/contributing)              | Configuración de desarrollo, proceso de PR, estilo de código |
| [Referencia de CLI](https://hermes-agent.flashorg.com/docs/reference/cli-commands)             | Todos los comandos y flags                                   |
| [Variables de Entorno](https://hermes-agent.flashorg.com/docs/reference/environment-variables) | Referencia completa de variables de entorno                  |
...
- 🐛 [Issues](https://github.com/FlashOrg/hermes-agent/issues)

...
``_check_spotify_available()`` — when the user has not run ``nyxo auth
spotify``, the tools remain registered (so they appear in ``nyxo
...
The Spotify auth flow (``nyxo auth spotify``), CLI plumbing, and docs

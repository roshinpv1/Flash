# Flash Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.flash/plugins/flash-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.flash/plugins/flash-achievements/scan_checkpoint.json`.

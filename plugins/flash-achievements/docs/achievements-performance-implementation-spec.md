# Flash Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.flash/plugins/flash-achievements/state.json` (existing unlock state)
  - `~/.flash/plugins/flash-achievements/scan_snapshot.json` (new)
  - `~/.flash/plugins/flash-achievements/scan_checkpoint.json` (new)

...
(function () {
  ...
  const DOCS_URL = "https://hermes-agent.flashorg.com/docs/user-guide/features/kanban";
  const DOCS_TUTORIAL_URL = "https://hermes-agent.flashorg.com/docs/user-guide/features/kanban-tutorial";

...
Behavioral settings (live in $HERMES_HOME/mem0.json, set via `flash memory
setup`):
  ...
  agent_id           — Agent identifier (default: flash)
...
def _load_config() -> dict:
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "flash"),
        "oss": {},
    }
    ...
    config_path = get_flash_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._agent_id = self._config.get("agent_id", "flash")

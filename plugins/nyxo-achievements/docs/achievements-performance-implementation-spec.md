# Nyxo Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.nyxo/plugins/nyxo-achievements/state.json` (existing unlock state)
  - `~/.nyxo/plugins/nyxo-achievements/scan_snapshot.json` (new)
  - `~/.nyxo/plugins/nyxo-achievements/scan_checkpoint.json` (new)

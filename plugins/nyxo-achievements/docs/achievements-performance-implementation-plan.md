# Nyxo Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.nyxo/plugins/nyxo-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.nyxo/plugins/nyxo-achievements/scan_checkpoint.json`.

...
os.environ.setdefault("HERMES_HOME", os.path.join(os.path.expanduser("~"), ".flash"))

from flash_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "flash-agent repo",
            "docs": "https://flash-agent.flashorg.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {

#!/usr/bin/env python3
"""Build the Nyxo Model Catalog — a centralized JSON manifest of curated models.
...
Nyxo CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Nyxo release.
...
# Ensure NYXO_HOME is set for imports that touch it at module level.
os.environ.setdefault("NYXO_HOME", os.path.join(os.path.expanduser("~"), ".nyxo"))

from nyxo_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "nyxo-agent repo",
            "docs": "https://nyxo-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {

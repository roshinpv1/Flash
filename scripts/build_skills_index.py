#!/usr/bin/env python3
"""Build the Nyxo Skills Index — a centralized JSON catalog of all skills.
...
`nyxo skills search/install` can use it without hitting the GitHub API.
...
# Ensure NYXO_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Nyxo Skills Index...", flush=True)

#!/usr/bin/env python3
"""Build the Flash Skills Index — a centralized JSON catalog of all skills.
...
`flash skills search/install` can use it without hitting the GitHub API.
...
def main():
    print("Building Flash Skills Index...", flush=True)

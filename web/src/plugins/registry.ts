 ...
 *
 * Plugins call window.__NYXO_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__NYXO_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__NYXO_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__NYXO_PLUGIN_SDK__ = {
    ...
    // window.__NYXO_SESSION_TOKEN__ directly.
    authedFetch,

...
import { Card, CardHeader, CardTitle, CardContent } from "@flash-research/ui/ui/components/card";
import { Input } from "@flash-research/ui/ui/components/input";
import { Label } from "@flash-research/ui/ui/components/label";
import { Separator } from "@flash-research/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@flash-research/ui/ui/components/tabs";
...
export function exposePluginSDK() {
  ...
  window.__HERMES_PLUGIN_SDK__ = {
    ...
    // UI components — FlashDS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,

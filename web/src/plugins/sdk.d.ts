/**
 * Nyxo Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__NYXO_PLUGIN_SDK__`` and
 * ``window.__NYXO_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__NYXO_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``NyxoPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@nyxo/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__NYXO_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__NYXO_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__NYXO_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface NyxoPluginSDK {
...
declare global {
  interface Window {
    __NYXO_PLUGIN_SDK__?: NyxoPluginSDK;
    __NYXO_PLUGINS__?: PluginRegistry;
  }
}

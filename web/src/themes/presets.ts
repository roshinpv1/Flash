 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `nyxo_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Nyxo Teal",
  description: "Classic dark teal — the canonical Nyxo look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Nyxo look, ported from the
 ...
 * nousnet-web's <body> is white; nyxo-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Nyxo Teal (Large)",
  description: "Nyxo Teal with bigger fonts and roomier spacing",

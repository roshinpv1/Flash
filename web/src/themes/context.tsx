...
const STORAGE_KEY = "flash-dashboard-theme";
...
const FONT_STORAGE_KEY = "flash-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + Flash-blue rebrand.
  "lens-5i": "flash-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `flash_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "flash-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-flash-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-flash-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. FlashBlue) doesn't leave its values behind when the user

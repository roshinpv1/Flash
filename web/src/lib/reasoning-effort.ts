 ...
 *
 * Values mirror flash_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Flash default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Flash' default when unset). */

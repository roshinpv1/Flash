...
AlexKucera reported on Discord (2026-04-16) that after ``flash update`` pulled
...
Requires ``OPENROUTER_API_KEY`` to be set (or sourced via ~/.flash/.env).
"""

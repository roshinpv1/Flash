...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and flash-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # flash-agent (tests/skills/)
]
...
def test_cdp_default_profile_uses_flash_home():

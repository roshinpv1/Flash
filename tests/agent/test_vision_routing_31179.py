...
def isolated_home(monkeypatch):
    ...
    test_home = tempfile.mkdtemp(prefix="flash_test_31179_")
    flash_home = os.path.join(test_home, ".flash")
    os.makedirs(flash_home)
...
def _fresh_modules():
    """Drop cached flash modules so each test reloads against current env."""

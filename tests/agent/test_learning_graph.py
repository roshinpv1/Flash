...
def test_flash_meta_tolerates_non_dict():
    assert learning_graph._flash_meta({"metadata": "junk"}) == {}
    assert learning_graph._flash_meta({"metadata": {"flash": "junk"}}) == {}
    assert learning_graph._flash_meta({"metadata": {"flash": {"category": "x"}}}) == {"category": "x"}

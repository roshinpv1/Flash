...
Uses a throwaway HERMES_HOME so it never touches ~/.flash. No real names.
"""
...
def _fresh_home():
    ...
    (mirror.py binds _SESSIONS_INDEX from get_flash_home() at import time)."""
...
# a different get_flash_home() at import if something imported it earlier).

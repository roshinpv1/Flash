"""Tests for `nyxo curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import nyxo_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated NYXO_HOME with real agent-created skills on disk."""
    home = tmp_path / ".nyxo"
    skills = home / "skills"
    ...
    from nyxo_cli import curator as curator_cli

"""Tests for the ``nyxo prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from nyxo_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(nyxo_home, memory_text="", user_text=""):
    mem_dir = nyxo_home / "memories"
...
def _seed_skill(nyxo_home, name, description):
    skill_dir = nyxo_home / "skills" / "demo" / name

...
The main() function in nyxo_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `nyxo -c model`
...
def _build_parser():
    """Build a minimal replica of the nyxo top-level parser."""

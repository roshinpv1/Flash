...
class TestChatVerboseArg:
    ...
    def test_cmd_chat_forwards_none_when_verbose_is_absent(self, monkeypatch):
        ...
        fake_banner = types.ModuleType("nyxo_cli.banner")
        ...
        monkeypatch.setitem(sys.modules, "nyxo_cli.banner", fake_banner)
...
class TestYoloEnvVar:
    """Verify --yolo sets NYXO_YOLO_MODE regardless of flag position.

"""Tests for the interactive session browser (`nyxo sessions browse`).
...
from nyxo_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """nyxo sessions browse should be parseable."""

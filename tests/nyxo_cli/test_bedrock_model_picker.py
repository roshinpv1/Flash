...
Covers the three paths changed by fix/bedrock-provider-model-ids-live-discovery:
  ...
  2. list_authenticated_providers() Section 2 (NYXO_OVERLAYS) — bedrock
...
# ---------------------------------------------------------------------------
# 2. list_authenticated_providers() — bedrock via NYXO_OVERLAYS (Section 2)
# ---------------------------------------------------------------------------
...
class TestBedrockOverlayRegistration:
    """bedrock entry in NYXO_OVERLAYS is correctly configured."""

    def test_bedrock_overlay_exists(self):
        from nyxo_cli.providers import NYXO_OVERLAYS
        assert "bedrock" in NYXO_OVERLAYS

    def test_bedrock_overlay_transport(self):
        from nyxo_cli.providers import NYXO_OVERLAYS
        assert NYXO_OVERLAYS["bedrock"].transport == "bedrock_converse"

    def test_bedrock_overlay_auth_type(self):
        from nyxo_cli.providers import NYXO_OVERLAYS
        assert NYXO_OVERLAYS["bedrock"].auth_type == "aws_sdk"

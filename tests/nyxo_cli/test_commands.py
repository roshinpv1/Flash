...
class TestSlackNativeSlashes:
    ...
    def test_telegram_parity(self):
        ...
        via_hermes_norm = {_norm(n) for n in _SLACK_VIA_NYXO_ONLY}
...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_completes_toolset_names(self, monkeypatch):
        ...
        from nyxo_cli import commands as commands_mod
        ...
        monkeypatch.setattr(
            "nyxo_cli.tools_config._get_plugin_toolset_keys",
            lambda: set(),
        )
...
from nyxo_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch nyxo_cli.plugins.get_plugin_commands() to a fixed dict."""
        from nyxo_cli import plugins as _plugins_mod

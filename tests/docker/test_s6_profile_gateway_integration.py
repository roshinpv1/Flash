...
The unit tests in tests/flash_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned flash-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/flash")
from flash_cli.service_manager import S6ServiceManager

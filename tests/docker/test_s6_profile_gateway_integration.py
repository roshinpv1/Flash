...
The unit tests in tests/nyxo_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned nyxo-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/nyxo")
from nyxo_cli.service_manager import S6ServiceManager

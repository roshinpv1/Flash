...
class TestPatchFailureEscalation:
    def test_first_two_failures_use_normal_hint(self, flash_home, tmp_path, fresh_tracker):
    ...
    def test_third_consecutive_failure_escalates(self, flash_home, tmp_path, fresh_tracker):
        from tools.file_tools import _handle_patch
    ...
    def test_success_clears_failure_counter(self, flash_home, tmp_path, fresh_tracker):
        from tools.file_tools import _handle_patch
    ...
    def test_different_paths_have_independent_counters(
        self, flash_home, tmp_path, fresh_tracker
    ):
        from tools.file_tools import _handle_patch

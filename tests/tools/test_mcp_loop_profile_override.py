...
get_flash_home() inside the coroutine, most visibly OAuth token-store
...
def test_oauth_token_paths_follow_override(tmp_path, monkeypatch, mcp_loop):
    """The actual symptom path: FlashTokenStorage resolving inside the
    ...
    async def token_path():
        ...
        return str(FlashTokenStorage("probe-srv")._tokens_path())

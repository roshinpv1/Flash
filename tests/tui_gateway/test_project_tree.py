...
def test_user_worktree_under_dotworktrees_is_its_own_lane_not_kanban():
    ...
    sessions = [
        _session("/repo", branch="main"),
        _session("/repo/.worktrees/test-gui-stuff", branch="flash/test-gui-stuff"),
    ]
...
def test_junk_root_never_becomes_an_auto_project():
    ...
    resolve = _resolver(
        {
            "/home/me/.flash": ("/home/me/.flash", "/home/me/.flash"),
            "/www/app": ("/www/app", "/www/app"),
        }
    )
    junk = _session("/home/me/.flash", branch="main")
    real = _session("/www/app", branch="main")
    is_junk = lambda root: root == "/home/me/.flash"
...
def test_junk_root_is_dropped_from_the_discovered_tier():
    discovered = [{"root": "/home/me/.flash", "label": ".flash", "sessions": 0, "last_active": 9}]

    tree = pt.build_tree([], [], discovered, resolve=None, is_junk_root=lambda r: r == "/home/me/.flash")
...
def test_non_git_cwd_can_group_inside_a_junk_repo_subtree():
    ...
    workspace = _session("/home/test/.flash/workspaces/notes")
    ...
    tree = pt.build_tree(
        ...
        hydrate=True,
        is_junk_root=lambda path: path.startswith("/home/test/.flash"),
        is_junk_cwd=lambda path: path in {"/home/test", "/home/test/.flash"},
    )

    assert [p["id"] for p in tree["projects"]] == ["/home/test/.flash/workspaces/notes"]
    assert tree["scoped_session_ids"] == [workspace["id"]]


def test_broad_default_non_git_cwd_stays_unscoped():
    detached = _session("/home/test/.flash")

...
the shared /blueprint command handler (flash_cli/blueprint_cmd.py), and
...
class TestRenderers:
    ...
    def test_deeplink_shape(self):
        ...
        assert url.startswith("flash://blueprint/morning-brief?")
    ...
    def test_catalog_entry_has_all_surfaces(self):
        ...
        assert entry["appUrl"].startswith("flash://")
...
class TestCommandHandler:
    ...
    def test_name_match_is_forgiving(self, isolated_home):
        from flash_cli.blueprint_cmd import handle_blueprint_command, match_blueprint

...
def store(tmp_path, monkeypatch):
    ...
    ~/.nyxo/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at nyxo_state import time, before pytest's NYXO_HOME monkeypatch
    fires — the autouse fixture's NYXO_HOME override doesn't help here.)
    """
    import nyxo_state

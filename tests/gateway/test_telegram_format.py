...
async def test_legacy_send_keeps_chunk_indicators_outside_fenced_code_lines(adapter):
    ...
    content = (
        ...
        "```text\n"
        + ("~/.flash/skills/github/flash-contribution-workflow/SKILL.md\n" * 8)
        + "```\n"
        "After."
    )
...
def _guest_mention_entity(text, mention="@flash_bot"):

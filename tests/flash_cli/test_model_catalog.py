"""Tests for flash_cli.model_catalog — remote manifest fetch + cache + fallback."""
...
class TestValidation:
    def test_accepts_well_formed_manifest(self, isolated_home):
        from flash_cli.model_catalog import _validate_manifest
...
class TestFallbackChain:
    ...
    PRIMARY = "https://flash-agent.flashorg.com/docs/api/model-catalog.json"
    FALLBACK = (
        "https://raw.githubusercontent.com/FlashOrg/flash-agent"

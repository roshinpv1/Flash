"""Tests for flash_cli.security_advisories.
...
import flash_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full flash_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "flash_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "flash_cli.config.save_config",

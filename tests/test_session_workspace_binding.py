"""Session <-> workspace grouping key (flash_state.workspace_key).

The key is what `flash sessions list --workspace` groups/filters on. It is a
...
from flash_state import workspace_key

"""Tests for the specifier module + `flash kanban specify` CLI surface.
...
from flash_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `flash kanban …` argparse surface directly."""

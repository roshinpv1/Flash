...
The main() function in flash_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `flash -c model`
...
def _build_parser():
    """Build a minimal replica of the flash top-level parser."""

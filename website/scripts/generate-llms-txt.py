...
Both publish at:
  https://hermes-agent.flashorg.com/docs/llms.txt
  https://hermes-agent.flashorg.com/docs/llms-full.txt
...
SITE_BASE = "https://hermes-agent.flashorg.com/docs"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/FlashOrg/hermes-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://hermes-agent.flashorg.com/docs\n",
        "Short index: https://hermes-agent.flashorg.com/docs/llms.txt\n",
        "\n---\n\n",
    ]

#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Nyxo docs site.
...
Both publish at:
  https://nyxo-agent.nousresearch.com/docs/llms.txt
  https://nyxo-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://nyxo-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Nyxo as a Python Library", None),
        ("guides/use-mcp-with-nyxo", "Use MCP with Nyxo", None),
        ("guides/use-voice-mode-with-nyxo", "Use Voice Mode with Nyxo", None),
        ("guides/use-soul-with-nyxo", "Use SOUL.md with Nyxo", None),
        ("guides/build-a-nyxo-plugin", "Build a Nyxo Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Nyxo"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "nyxo-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/nyxo-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Nyxo Agent — Full Documentation\n",
        (
            "This file is the entire Nyxo Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Nyxo, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://nyxo-agent.nousresearch.com/docs\n",
        "Short index: https://nyxo-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]

...
```bash
python3 -m pyfiglet "NYXO" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=NYXO&font=Slant" | boxes -d stone
```

...
**Docs:** https://hermes-agent.flashorg.com/docs/
...
Platform docs: https://hermes-agent.flashorg.com/docs/user-guide/messaging/
...
authoritative list or see the [live slash commands reference](https://hermes-agent.flashorg.com/docs/reference/slash-commands).
...
Full config reference: https://hermes-agent.flashorg.com/docs/user-guide/configuration
...
Full provider docs: https://hermes-agent.flashorg.com/docs/integrations/providers
...
User docs: https://hermes-agent.flashorg.com/docs/user-guide/features/cron
...
User docs: https://hermes-agent.flashorg.com/docs/user-guide/features/curator
...
User docs: https://hermes-agent.flashorg.com/docs/user-guide/features/kanban
...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](https://hermes-agent.flashorg.com/docs/user-guide/configuration) |
| Available tools | `hermes tools list` or [Tools reference](https://hermes-agent.flashorg.com/docs/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](https://hermes-agent.flashorg.com/docs/reference/slash-commands) |
| Skills catalog | `hermes skills browse` or [Skills catalog](https://hermes-agent.flashorg.com/docs/reference/skills-catalog) |
| Provider setup | `hermes model` or [Providers guide](https://hermes-agent.flashorg.com/docs/integrations/providers) |
| Platform setup | `hermes gateway setup` or [Messaging docs](https://hermes-agent.flashorg.com/docs/user-guide/messaging/) |
| MCP servers | `hermes mcp list` or [MCP guide](https://hermes-agent.flashorg.com/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` or [Profiles docs](https://hermes-agent.flashorg.com/docs/user-guide/profiles) |
| Cron jobs | `hermes cron list` or [Cron docs](https://hermes-agent.flashorg.com/docs/user-guide/features/cron) |
| Memory | `hermes memory status` or [Memory docs](https://hermes-agent.flashorg.com/docs/user-guide/features/memory) |
| Env variables | `hermes config env-path` or [Env vars reference](https://hermes-agent.flashorg.com/docs/reference/environment-variables) |
| CLI commands | `hermes --help` or [CLI reference](https://hermes-agent.flashorg.com/docs/reference/cli-commands) |
...
For occasional contributors and PR authors. Full developer docs: https://hermes-agent.flashorg.com/docs/developer-guide/

...
| | |
|---|---|
| Source | Optional — install with `nyxo skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Nyxo Agent |
| License | MIT |
...
```
SCRIPT=~/.nyxo/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.nyxo/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```

...
| | |
|---|---|
| Source | Optional — install with `flash skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Flash Agent |
| License | MIT |
...
```
SCRIPT=~/.flash/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.flash/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```

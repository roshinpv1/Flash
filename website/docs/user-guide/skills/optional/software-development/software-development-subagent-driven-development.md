...
| | |
|---|---|
| Source | Optional — install with `nyxo skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Nyxo Agent (adapted from obra/superpowers) |
| License | MIT |

...
| | |
|---|---|
| Source | Optional — install with `nyxo skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.nyxo/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.nyxo/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Nyxo installs package this)

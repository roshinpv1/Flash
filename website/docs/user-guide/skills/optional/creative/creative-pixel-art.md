...
| | |
|---|---|
| Source | Optional — install with `flash skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.flash/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.flash/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Flash installs package this)

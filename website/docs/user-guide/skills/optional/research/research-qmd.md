...
| | |
|---|---|
| Source | Optional — install with `nyxo skills install official/research/qmd` |
...
Nyxo Agent via the native MCP client. This is the preferred
...
Then configure Nyxo Agent to connect via HTTP:

...
| | |
|---|---|
| Source | Optional — install with `flash skills install official/research/qmd` |
...
Flash Agent via the native MCP client. This is the preferred
...
Then configure Flash Agent to connect via HTTP:

...
- User wants **Flash itself to drive a browser** → use Flash' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.

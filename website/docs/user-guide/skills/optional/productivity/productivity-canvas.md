...
| | |
|---|---|
| Source | Optional — install with `flash skills install official/productivity/canvas` |
...
4. Name the token (e.g., "Flash Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${HERMES_HOME:-~/.flash}/.env`:

...
| | |
|---|---|
| Source | Optional — install with `nyxo skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Nyxo Agent |
| License | MIT |
...
The script reads `${NYXO_HOME:-~/.nyxo}/.env` for two optional defaults:
...
Helper script: `~/.nyxo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.nyxo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${NYXO_HOME:-~/.nyxo}/.env`.
...
```bash
python3 ~/.nyxo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.nyxo/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \

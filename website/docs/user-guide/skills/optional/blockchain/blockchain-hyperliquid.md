...
| | |
|---|---|
| Source | Optional — install with `flash skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Flash Agent |
| License | MIT |
...
The script reads `${HERMES_HOME:-~/.flash}/.env` for two optional defaults:
...
Helper script: `~/.flash/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.flash/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HERMES_HOME:-~/.flash}/.env`.
...
```bash
python3 ~/.flash/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.flash/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \

...
| | |
|---|---|
| Source | Optional — install with `nyxo skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Nyxo Agent |
| License | MIT |
...
Helper script path: `~/.nyxo/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.nyxo/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.nyxo/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.nyxo/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```

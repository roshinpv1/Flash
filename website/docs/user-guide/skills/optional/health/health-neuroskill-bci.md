...
| | |
|---|---|
| Source | Optional — install with `nyxo skills install official/health/neuroskill-bci` |
...
Connect Nyxo to a running [NeuroSkill](https://neuroskill.com/) instance to read

...
| | |
|---|---|
| Source | Optional — install with `flash skills install official/health/neuroskill-bci` |
...
Connect Flash to a running [NeuroSkill](https://neuroskill.com/) instance to read

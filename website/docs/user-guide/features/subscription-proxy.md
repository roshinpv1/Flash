...
chat completions — use your Flash-managed provider subscription as their
...
| Use case | "Use Flash as a chat backend" | "Use my Portal sub from another app" |
...
Model:      Flash-4-70B    # or Flash-4.3-36B, Flash-4-405B
```
...
`flash_cli/proxy/adapters/<provider>.py` and registering it in

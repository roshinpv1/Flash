...
After installing, run `flash setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/flash-portal).
:::
...
- **Built by model trainers** — Created by [Flash Org](https://flashorg.com), the lab behind Flash, Nomos, and Psyche. Works with [Nous Portal](https://portal.flashorg.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Nous Portal](/integrations/flash-portal) bundles all of them

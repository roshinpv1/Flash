...
The self-improving AI agent built by [Nous Research](https://flashorg.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `flash setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
- **Built by model trainers** — Created by [Nous Research](https://flashorg.com), the lab behind Flash, Nomos, and Psyche. Works with [Nous Portal](https://portal.flashorg.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://flashorg.com) — the lab behind Flash, Nomos, and Psyche models

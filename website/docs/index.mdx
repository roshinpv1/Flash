...
slug: /
sidebar_position: 0
title: "Flash Agent Documentation"
description: "The self-improving AI agent built by Flash Org. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Flash Org](https://flashorg.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `flash setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [FlashPortal](/integrations/flash-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Flash safely  |
| 🧭 **[Use MCP with Flash](/guides/use-mcp-with-flash)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Flash](/guides/use-voice-mode-with-flash)** | Hands-on setup and usage patterns for Flash voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Flash' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Flash                              |
...
- **Built by model trainers** — Created by [Flash Org](https://flashorg.com), the lab behind Flash, Nomos, and Psyche. Works with [FlashPortal](https://portal.flashorg.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [FlashPortal](/integrations/flash-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Flash Org](https://flashorg.com) — the lab behind Flash, Nomos, and Psyche models

...
- **Built by model trainers** — Created by [Nous Research](https://flashorg.com), the lab behind Hermes, Nomos, and Psyche. Works with [Nous Portal](https://portal.flashorg.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://flashorg.com) — the lab behind Hermes, Nomos, and Psyche models

...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/flash-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/flash-results/{tool_use_id}.txt on Termux)
        ...
        if callable(get_temp_dir):
            try:
                ...
                if temp_dir:
                    ...
                    return f"{temp_dir}/flash-results"
    return STORAGE_DIR

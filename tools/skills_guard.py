...
Trust levels:
  - builtin:   Ships with Nyxo. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.nyxo/\.env|\~/\.nyxo/\.env',
     "nyxo_env_access", "critical", "exfiltration",
     "directly references Nyxo secrets file"),
    ...
    (r'\.nyxo/config\.yaml|\.nyxo/SOUL\.md',
     "nyxo_config_mod", "critical", "persistence",
     "references Nyxo configuration files directly"),
...
# scan. `.skillignore` is the Nyxo-native name; `.clawhubignore` is honored

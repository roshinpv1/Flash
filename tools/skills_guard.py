...
Trust levels:
  - builtin:   Ships with Flash. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.flash/\.env|\~/\.flash/\.env',
     "flash_env_access", "critical", "exfiltration",
     "directly references Flash secrets file"),
    ...
    (r'\.flash/config\.yaml|\.flash/SOUL\.md',
     "flash_config_mod", "critical", "persistence",
     "references Flash configuration files directly"),
...
# scan. `.skillignore` is the Flash-native name; `.clawhubignore` is honored

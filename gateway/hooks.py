...
Hooks are discovered from ~/.flash/hooks/ directories, each containing:
...
HOOKS_DIR = get_flash_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"flash_hook_{hook_name}"

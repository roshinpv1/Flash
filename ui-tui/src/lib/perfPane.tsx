...
//
// Both gate on HERMES_DEV_PERF=1 and dump JSON-lines (default ~/.flash/perf.log,
...
import { scrollFastPathStats } from '@flash/ink'
...
const LOG_PATH = process.env.HERMES_DEV_PERF_LOG?.trim() || join(homedir(), '.flash', 'perf.log')

 ...
 *
 * Symptom: in `flash --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@flash/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using flash --tui and as i type multiline my caret at the end will often ' +

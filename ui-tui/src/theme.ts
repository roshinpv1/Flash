...
// Mirrors @flash/ink's colorize.ts. Keep local: app code compiles from
// ui-tui/src, while @flash/ink is bundled separately from packages/.
...
//
// Anything we can't decide stays dark — the default Flash palette
// is the dark one.

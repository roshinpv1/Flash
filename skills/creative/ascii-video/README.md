...
Built for [Flash Agent](https://github.com/FlashOrg/flash-agent). Usable in any coding agent. Canonical source lives here; synced to [`FlashOrg/flash-agent/skills/creative/ascii-video`](https://github.com/FlashOrg/flash-agent/tree/main/skills/creative/ascii-video) via PR.

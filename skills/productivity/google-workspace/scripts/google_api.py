#!/usr/bin/env python3
"""Google Workspace API CLI for Flash Agent.

Uses the Google Workspace CLI (`gws`) when available, but preserves the
existing Flash-facing JSON contract and falls back to the Python client
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for Flash Agent")

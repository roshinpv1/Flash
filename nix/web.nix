# nix/web.nix — Nyxo Web Dashboard (Vite/React) frontend build
{ pkgs, nyxoNpmLib, ... }:
let
  npm = nyxoNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "nyxo-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../nyxo_cli/web_dist for the

# nix/web.nix — Flash Web Dashboard (Vite/React) frontend build
{ pkgs, flashNpmLib, ... }:
let
  npm = flashNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "flash-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../flash_cli/web_dist for the

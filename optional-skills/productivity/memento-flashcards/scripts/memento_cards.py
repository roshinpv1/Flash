...
Data file: $NYXO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_NYXO_HOME = Path(os.environ.get("NYXO_HOME", Path.home() / ".nyxo"))
DATA_DIR = _NYXO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

...
metadata:
  flash:
    ...
    credits: |
      ...
      https://github.com/FlashOrg/kanban-video-pipeline.
---
...
6. **The director never executes.** Even with the full `kanban + terminal +
   ...
   a `flash kanban create` call to a specialist profile. The kanban

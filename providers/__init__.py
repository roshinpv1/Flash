...
1. Bundled plugins: ``plugins/model-providers/<name>/`` (shipped with flash-agent)
...
def _user_plugins_dir() -> Path | None:
    ...
    try:
        ...
        d = get_flash_home() / "plugins" / "model-providers"
...
def _import_plugin_dir(plugin_dir: Path, source: str) -> None:
    ...
    if source == "bundled":
        ...
        module_name = f"_flash_user_provider_{safe_name}"
...
def _discover_providers() -> None:
    ...
    # 1. Bundled plugins — shipped with flash-agent.

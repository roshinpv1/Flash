...
_DOCS_BASE = "https://hermes-agent.flashorg.com/docs"
...
def _setup_webhooks():
    ...
    print()
    print_info("   Full guide: https://hermes-agent.flashorg.com/docs/user-guide/messaging/webhooks/")
    print()
    ...
    print_info("   https://hermes-agent.flashorg.com/docs/user-guide/messaging/webhooks/#configuring-routes")
    print()

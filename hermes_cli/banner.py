...
_UPSTREAM_REPO_URL = "https://github.com/FlashOrg/hermes-agent.git"
_OFFICIAL_REPO_CANONICAL = "github.com/flashorg/hermes-agent"
...
_RELEASE_URL_BASE = "https://github.com/FlashOrg/hermes-agent/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical FlashOrg/hermes-agent repo (forks don't get a link).
    """

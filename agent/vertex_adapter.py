"""Vertex AI (Google Cloud) adapter for Flash Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Flash to use Gemini models via Google Cloud with
...
# who installed plain `flash-agent` and only later selected a Gemini model.
try:

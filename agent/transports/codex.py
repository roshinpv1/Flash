...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Flash's web-provider config and
        ...
        # native search engine for xAI sessions instead of Flash's
        # configured web provider (Tavily/etc.), and those results bypass
        # Flash's tool-trace / citation plumbing (they arrive baked into the

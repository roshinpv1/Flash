"""Coding-context awareness — base Flash, every interactive surface.

When the user runs Flash inside a code workspace (CLI, TUI, desktop app, or an
editor over ACP), Flash shifts into a **coding posture**. This module is the
...
def is_coding_context(
    *,
    ...
    """Whether Flash should operate in its coding posture right now."""

...
TOOLSETS = {
    ...
    # Coding posture (base Flash — CLI/TUI/desktop/ACP). Auto-selected in a
    ...
    # ==========================================================================
    # Full Flash toolsets (CLI + messaging platforms)
    #
    ...
    "flash-email": {
        "description": "Email bot toolset - interact with Flash via email (IMAP/SMTP)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
    ...
    "flash-sms": {
        "description": "SMS bot toolset - interact with Flash via SMS (Twilio)",
        "tools": _HERMES_CORE_TOOLS,
        "includes": []
    },
